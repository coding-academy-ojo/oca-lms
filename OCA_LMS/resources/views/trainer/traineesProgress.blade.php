...
<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 mb-4">
    <div class="widget-stat card">
        <div class="card-body">
            <p class="card-title text-primary" style="font-size: 1.2rem;">Late Assignments Submissions</p>
            ...
            <div class="progress mb-2 my-2">
                <div class="progress-bar progress-animated bg-success" style="width: {{ $lateAssignmentSubmissions['latePercentage'] }}%">{{ $lateAssignmentSubmissions['lateSubmissionsCount'] }}</div>
            </div>
            <small>{{ $lateAssignmentSubmissions['lateSubmissionsCount'] }} late ({{ $lateAssignmentSubmissions['latePercentage'] }}%)</small>
            
            <div class="progress mb-2 my-2">
                <div class="progress-bar progress-animated bg-info" style="width: {{ $lateAssignmentSubmissions['onTimePercentage'] }}%">{{ $lateAssignmentSubmissions['onTimeCount'] }}</div>
            </div>
            <small>{{ $lateAssignmentSubmissions['onTimeCount'] }} on time ({{ $lateAssignmentSubmissions['onTimePercentage'] }}%)</small>
            
            <div class="progress mb-2 my-2">
                <div class="progress-bar progress-animated bg-warning" style="width: {{ $lateAssignmentSubmissions['didNotSubmitPercentage'] }}%">{{ $lateAssignmentSubmissions['didNotSubmitCount'] }}</div>
            </div>
