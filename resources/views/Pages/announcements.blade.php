...
<div class="container">
    ...
    <!-- All announcements will appear here based on newest date and time  -->
    @if ($announcements)
    @foreach($announcements as $announcement)
    <div class="card col-10 m-auto my-4">
        <div class="card-header d-flex justify-content-between align-items-center"
            style="background-color: #FDF0E5; color:black">
        ...
        <div class="card-body contentDiv d-flex justify-content-between">
            ...
            <div class="col-2">
                <span class="mx-2 text-break">{{ $announcement->created_at->format('Y-m-d H:i') }}</span>
            </div>
        </div>
